...
(**
    Functions for parsing php programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a php program from a string into a typed OCaml CST.
...
(** Parse a php program from a file into a typed OCaml CST.
